export const SKIN_CATALOG = Object.freeze([
  {
    ...
    tagline: "最熟悉的元气原型",
    buffTitle: "元气早餐",
    buffDescription: "每关第一颗成功蛋额外 +2 金币",
    buff: { firstEggCoinBonus: 2 },
  },
  {
    id: "drummer",
    name: "鼓手旦仔",
  ...
  },
  {
    ...
    tagline: "锅边旋转登场",
    buffTitle: "连舞",
    buffDescription: "每 3 颗成功蛋额外 +6 金币",
    buff: { coinEvery: 3, periodicCoinBonus: 6 },
  },
  {
    id: "stone-age",
    name: "石器旦仔",
    ...
    tagline: "原始火力全开",
    buffTitle: "原始猛火",
    buffDescription: "火力更快，出锅金币 ×1.4",
    buff: { heatSpeedMultiplier: 1.15, serveCoinMultiplier: 1.4 },
  },
  {
    id: "carrot",
    name: "萝卜旦仔",
    ...
    tagline: "便宜又醒目",
    buffTitle: "丰收",
    buffDescription: "每颗成功蛋额外 +2 金币",
    buff: { serveCoinBonus: 2 },
  },
  {
    id: "detective",
    name: "侦探旦仔",
