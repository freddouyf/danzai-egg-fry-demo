...
export const RHYTHM_DISH_LEVELS = Object.freeze([
  ...
  Object.freeze({
    ...
    commands: Object.freeze([
      ...
      step({ id: "plate-crack", input: RHYTHM_COMMAND_TYPES.TAP, actionName: "敲蛋", prompt: "敲蛋！", helperText: "进命中区再点", scene: "crack", visualKey: "egg-on-plate", dishStepIndex: 2, targetDelayMs: 660, tapDurationMs: 1_100, goodMs: 280 }),
      step({ id: "plate-stir", input: RHYTHM_COMMAND_TYPES.MASH, actionName: "快速翻炒", prompt: "快速翻炒！", helperText: "打满进度", scene: "mash", visualKey: "stir", dishStepIndex: 3, mashDurationMs: 2_000, targetTaps: 10 }),
      step({ id: "plate-serve", input: RHYTHM_COMMAND_TYPES.TAP, actionName: "装盘出餐", prompt: "装盘出餐！", helperText: "最后一下上桌", scene: "serve", visualKey: "plate", dishStepIndex: 4, targetDelayMs: 660, tapDurationMs: 1_100, goodMs: 280 }),
    ]),
  }),
]);
